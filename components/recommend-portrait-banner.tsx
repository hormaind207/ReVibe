...
const STORAGE_KEY = 'recommend_portrait_dismissed'

export function RecommendPortraitBanner({ open, onClose }: { open: boolean; onClose: () => void }) {
...
export function shouldShowRecommendPortrait(): boolean {
